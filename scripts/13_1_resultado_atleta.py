...
print("Procesando 13_RESULTADO_ATLETA (Version Optimizada)...")
...
df_res_crudo['YEAR'] = df_res_crudo['Games'].str.extract(r'(\d{4})').astype(float)
df_res_crudo['SEASON'] = df_res_crudo['Games'].str.extract(r'(Summer|Winter)')
...
df_res_crudo['ID_MEDALLA'] = df_res_crudo['ID_MEDALLA'].fillna(1).astype(int)
